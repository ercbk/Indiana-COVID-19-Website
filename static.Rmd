...
```{r}
ind_line_path <- glue::glue("tracker/plots/ind-combo-line-{ind_combo_date}.png")
...
```{r ,align="center"}
pos_policy_path <- glue::glue("tracker/plots/pos-policy-line-{pos_policy_date}.png")
...
```{r}
hosp_iv_path <- glue::glue("tracker/plots/hosp-icu-vent-{hosp_iv_date}.png")
...
```{r}
pos_rate_path <- glue::glue("tracker/plots/pos-rate-line-{pos_rate_date}.png")
...
```{r}
ot_rest_path <- glue::glue("tracker/plots/ot-rest-line-{ot_rest_date}.png")
...
```{r}
goog_mob_path <- glue::glue("tracker/plots/goog-mob-line-{goog_mob_date}.png")
...
```{r, align="center"}
region_dea_path <- glue::glue("tracker/plots/region-dea-line-{region_dea_date}.png")
knitr::include_graphics(region_dea_path)
```

```{r, align="center"}
region_pos_path <- glue::glue("tracker/plots/region-pos-line-{region_pos_date}.png")
...
```{r, align="center"}
county_pos_path <- glue::glue("tracker/plots/county-pos-bar-{county_pos_date}.png")
...
```{r}
daily_re_path <- glue::glue("tracker/plots/daily-re-line-{daily_re_date}.png")
...
## Excess Deaths  
```{r}
exc_death_path <- glue::glue("tracker/plots/excess-death-col-{exc_death_date}.png")
