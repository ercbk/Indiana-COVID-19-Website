...
state_msa_line <- highchart() %>%
   ...
   # nid is for "relative" height arg. relative arg is a mess. Best config I seen is setting them all to the same nid and messing with showLast/FirstLabel configurations 
   hc_add_yAxis(nid = 1L,
